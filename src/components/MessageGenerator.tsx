...
const MessageGenerator = () => {
  ...
  return <Card className="p-6 space-y-4 text-center max-w-lg mx-auto border-opacity-30">
      <div className="space-y-2">
        <img alt="OM Oracle" className="mx-auto w-72 h-auto rounded-lg shadow-md" src="https://drive.google.com/file/d/1ufKPCVv8rXLMSulyM54wNO1r0wxyvvmK/view?usp=share_link" />
